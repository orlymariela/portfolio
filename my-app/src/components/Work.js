...
const Work = () => {
    return (
        <div name='work' className='w-full md:h-screen bg-[#27272a] text-gray-300 '>
            <div className='max-w-[1000px] mx-auto py-4 flex flex-col justify-center w-full h-full'>
                ...
                className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'> {/*gap se usa para controlar el espacio entre los elementos dentro de un contenedor cuadricula*/}
                <div className='shadow-lg shadow-[#202022] group container rounded-md flex justify-center items-center mx-auto content-div'>
