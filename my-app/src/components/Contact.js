...
const Contact = () => {
  return (
    <div id='contact' className='w-full min-h-screen bg-[#27272a] text-gray-300 flex justify-center items-center py-4'>
        <form method='POST' action='https://getform.io/f/f6401556-6fe5-4e07-ad5b-bc049237aeb4' className='flex flex-col max-w-auto'>
          <div className='pb-8'>
