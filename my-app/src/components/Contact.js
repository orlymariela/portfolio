...
const Contact = () => {
  return (
    <>
      <div id='contact' className='w-full min-h-screen bg-[#27272a] text-gray-300 flex justify-center items-center'>
        <form method='POST' action='https://getform.io/f/f6401556-6fe5-4e07-ad5b-bc049237aeb4' className='flex flex-col md:max-w-auto pt-10 px-5'>
          ...
          <button className='text-white border-2 hover:bg-[#F2910A] hover:border-[#F2910A] hover:text-[white] px-4 py-3 my-6 mx-auto flex items-center'>Let's Collaborate</button>
        </form>
      </div>
    </>
  )
